<section id="dashboard-hub" class="ms-lg-5 text-lg-start w-100 d-none">
    ...
    <div class="d-flex bd-highlight justify-content-between bg-color-purple-faded">
        ...
        <div class="p-2 bd-highlight">
            ...
            <table class="table bg-color-purple-faded ">
                ...
                <tr class="">
                    <?php $test = ""; ?>
                    <input type="hidden" name="test2" value="2" id="test2"" />                    <td value="13" name="test" class="">Les Maîtres de la faille</td>
                ...
                <script>
                    const test = <?php print(json_encode($test)) ?>;
                </script>
                <tr>
