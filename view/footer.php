...
<!-- Footer -->
<footer class="container-fluid bg-color-purple-faded bottom-nav-margin d-flex flex-column justify-content-center align-items-center gap-1 py-2 mt-5" style="margin-top:350px;">
