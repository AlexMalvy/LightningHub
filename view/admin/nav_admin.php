        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenu">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        <a id="nav-hub" class="nav-link" href="#"><i class="fa-solid fa-comments me-2"></i>Voir les salons</a>
                    </li>
                    <li class="nav-item">
                        <a id="nav-create-hub" class="nav-link" href="#"><i class="fa-solid fa-plus me-2"></i>Ajouter un salon</a>
                    </li>
                    <hr/>
